...
The output shows in your console and all the packages are loaded that are associated under that 1 package
...
Timeseries you always keep the NA's and other datasets you migth remove
